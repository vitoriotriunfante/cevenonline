...
| `mix_aderencia_regional`, `rf_clientes_2026` | 🔴 NÃO RESOLVIDO — depende de um CSV baixado manualmente da Receita Federal (`clientes_rf_2026-09-12 (1).csv`, arquivo de 12/09), não vem de nenhuma API do CEVEN. **Preciso saber do Vitório: de onde vem esse CSV e como gerar uma versão atualizada?** Não é algo que dá pra automatizar sem essa resposta. | `analises/enriquecer_clientes_rf_e_gerar_mix.js` |
